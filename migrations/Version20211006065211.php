 ...
 */
final class Version20211006065211 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates table `messenger_messages` and add trigger `messenger_messages';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TRIGGER notify_trigger 
