 ...
 */
final class Version20210914155510 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Creates `comment` and `conference` tables and its relationships';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(
            'ALTER TABLE comment ADD 
                    CONSTRAINT FK_COMMENT_CONFERENCE_ID FOREIGN KEY (conference_id) 
                    REFERENCES conference (id) NOT DEFERRABLE INITIALLY IMMEDIATE'
        );
    }
